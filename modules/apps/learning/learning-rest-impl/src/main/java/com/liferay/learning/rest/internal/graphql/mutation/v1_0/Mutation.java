...
package com.liferay.learning.rest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	public Response createBooksPageExportBatch(
		...
		return _applyComponentServiceObjects(
			...
			bookResource -> bookResource.postBooksPageExportBatch(
	...
	private void _populateResourceContext(BookResource bookResource)
		...
		bookResource.setVulcanBatchEngineExportTaskResource(
			_vulcanBatchEngineExportTaskResource);

		bookResource.setVulcanBatchEngineImportTaskResource(
...
// LIFERAY-REST-BUILDER-HASH:1267691939