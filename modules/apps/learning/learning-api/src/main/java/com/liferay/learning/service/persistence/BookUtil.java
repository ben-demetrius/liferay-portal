...
/**
 * The persistence utility for the book service. This utility wraps <code>com.liferay.learning.service.persistence.impl.BookPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BookUtil {
	...
	public static Book findByGroupId_First(
		...
		throws com.liferay.learning.exception.NoSuchBookException {
	 ...
	 * @return the ordered range of matching books
	 */
	public static List<Book> findByG_T(
	 ...
	 * @throws NoSuchBookException if a matching book could not be found
	 */
	public static Book findByG_T_First(
	 ...
	 * @return the first matching book, or <code>null</code> if a matching book could not be found
	 */
	public static Book fetchByG_T_First(
	 ...
	 * @return the matching books
	 */
	public static List<Book> findByG_T(long groupId, String title) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-189325063