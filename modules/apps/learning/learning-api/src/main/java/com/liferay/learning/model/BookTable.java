...
/**
 * The table class for the &quot;Book&quot; database table.
 *
...
public class BookTable extends BaseTable<BookTable> {
	...
	public final Column<BookTable, String> isbn = createColumn(
		"isbn", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);

	private BookTable() {
		super("Book", BookTable::new);
	}

}
// LIFERAY-SERVICE-BUILDER-HASH:-1063089069