...
public class ObjectEntryModelListenerAuditTest {
	...
	public void testOnAfterCreateWithLocalizedValues() throws Exception {
		...
		_assertLocalizedValues("Description", "Descrição");
	}
	...
	private void _assertLocalizedValues(String enUSValue, String ptBRValue) {
		Map<String, String> expectedLocalizedValues = TreeMapBuilder.put(
			_objectField.getName(), enUSValue
		).put(
			_objectField.getName() + "[pt_BR]", ptBRValue
		).build();
